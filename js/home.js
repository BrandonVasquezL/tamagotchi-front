...
buttonGuardar.addEventListener('click', ()=>{
    if(mascota.dueno != ''){
        axios.post('https://pokebackend-production.up.railway.app/actualizar', {
            vida: mascota.vida,
...
eliminarButton.addEventListener('click', ()=>{
    ...
    if(userEliminar === '' || contraEliminar === ''){
        ...
        axios.post('https://pokebackend-production.up.railway.app/eliminar', {
...
iniciarButton.addEventListener('click', ()=>{
    ...
    if(user === '' || contra === ''){
        ...
        axios.post('https://pokebackend-production.up.railway.app/iniciarSesion', {
            contrasena: contra,
            usuario: user
        }).then((respuesta)=>{
